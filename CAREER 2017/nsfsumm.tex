...
mapped to \textit{actionable hints} for administrators to improve workload-aware
...
on workloads and produce dynamic hints for tuning elastic storage systems.
...
The PI will architect AutoTune, a system that maps metrics to tuning hints while accounting for inter and intra-workload metric interactions.  
The PI aims to
