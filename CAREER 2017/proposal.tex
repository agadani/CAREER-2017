...
In a not-too-distant future where the devices we use are not just networked, but
...
users, or workloads, that the system serves. %There are many factors, from cache size to device type to the redundancy model, to balance when designing a storage system.
...
% FIXME **Maybe this objective should be focused overall to reduce overprovisioning, as that's the costly element?
...
ground truth. 
%FIXME Any chance you can first apply it to real systems on which you do have a ground truth for validation purposes? Just because the artificial Gaussian simulation *may* be fairly far away from the truth of real data?
...
%FIXME is there a citation for this type of work, or totally novel? I'm wondering if there's a way to visualize this plan? Formula? Schematic? I don't know your audience and how technically savvy they are. If they're less savvy than you, then mathy pictures are good. Otherwise ignore me. 
...
%FIXME  does out of order mean incorrectly sorted, or broken (like,timestamps or elevators?)
...
%FIXME I think this section is much improved btw. The technical details ground it in application instead of just concept
%\begin{figure}
%\centering
...
%FIXME there's nothing in here that shows/interprets results anymore. Must be in the green part (that I'm ignoring since it won't show up in the text)
we
...
%FIXME I can say for sure the two sentences above this are composed of words, but mean very little to me. Are they jargon or is there specific plan information in them about what you're going to do?
For example, a
...
%FIXME This is both more informative and redundant with the two sentences above that I couldn't understand.  How about just go with this one? 
