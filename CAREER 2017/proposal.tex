...
%* FIXME VISION STATEMENT HERE**

My research involves BIG BOLD STATEMENT ABOUT HOW I'M GOING TO CHANGE THE DAMN WORLD AND TAKE DOWN THE PATRIARCHY.


Tuning a storage system is a delicate
balance between reliability, availability, security, performance spread over the
users of the system. %There are many factors, from cache size to device type to the redundancy model, to balance when designing a storage system.
...
studies and thus undermines the scientific endeavor of storage analysis.%}}} ... but how is this different than other fields? 
...
proportion of interleaved working sets~\cite{seo_char}.  %<--This sentence is an orphan.
...
%FANTASTIC.  THEY SOLVE ALL THE PROBLEMS AND DEEP LEARNING BUZZWORD.  Also, I can point to my brain stuff here which is otherwise totally unrelated.
